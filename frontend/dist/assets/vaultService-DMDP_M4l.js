...
import { f as F, r as Q, E as x, n as H, x as D, B as g, H as G, N as w, M as K, C as q, s as W, R as b, Q as M, __tla as __tla_1 } from "./index-CpUUqZU0.js";
        ...
        async getTrashList () {
            ...
            try {
                const { useLayoutStore: n } = await z(async ()=>{
                    const { useLayoutStore: o } = await import("./index-CpUUqZU0.js").then(async (m)=>{
                        await m.__tla;
                        return m;
                    }).then((i)=>i.w);
                    return {
    ...
    $ = async (t)=>{
        if (t && t.secret && !t.secret.startsWith("nodeauth:")) {
            const { useAppLockStore: n } = await z(async ()=>{
                const { useAppLockStore: s } = await import("./index-CpUUqZU0.js").then(async (m)=>{
                    await m.__tla;
                    return m;
                }).then((o)=>o.b);
                return {
            ...
            if (r) {
                const { maskSecretFront: s } = await z(async ()=>{
                    const { maskSecretFront: o } = await import("./index-CpUUqZU0.js").then(async (m)=>{
                        await m.__tla;
                        return m;
                    }).then((i)=>i.m);
                    return {
                        ...
                        if (!p?.success) {
                            ...
                            if (v) {
                                ...
                                const { useOfflineStore: m } = await z(async ()=>{
                                    const { useOfflineStore: y } = await import("./index-CpUUqZU0.js").then(async (m)=>{
                                        await m.__tla;
                                        return m;
                                    }).then((T)=>T.y);
                                    return {
